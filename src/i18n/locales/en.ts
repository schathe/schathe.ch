    ...
    experiences: {
        ...
        items: [
            ...
            },
            {
                title: 'Juramigrants',
                date: '2018',
                description: 'Created the Juramigrants website and its members area, a private social network.',
            },
            {
                title: 'Internship',
                date: '2020 - 2021',
        ...
        items: [
            {
                title: 'Juramigrants',
                tech: 'WordPress',
                description: 'My first website, built during my IT apprenticeship. The site has two sections: a showcase website and a private social network for members. The site has since been updated, the old logo was available on benevolat-jura.ch.',
                link: '',
                linkLabel: '',
            },
            {
                title: 'Temineur',
                tech: 'C++ / SFML',
                description: 'When I started my Bachelor\'s, I decided to build a minesweeper without any external help, using only official documentation. This project helped me get back into programming after a period without personal projects.',
            ...
            },
            {
                ...
                tech: 'Godot',
                description: 'A metroidvania-inspired platformer created to explore the Godot engine. The project was put on hold due to Bachelor workload but will be picked up again in the future.',
